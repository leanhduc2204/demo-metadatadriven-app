  ...
  return (
    ...
    >
      <div
        {...attributes}
        {...listeners}
        className="cursor-grab active:cursor-grabbing text-neutral-500 p-1 hover:text-neutral-700"
      >
      ...
      <Button
        variant={"ghost"}
        size={"sm"}
        className="justify-start text-neutral-500 text-sm font-light gap-3 flex-1 hover:bg-transparent cursor-default"
      >
        <Icon size={16} />
      ...
      <PopoverContent className="w-56 p-0 py-1 flex flex-col gap-1" align="end">
        {showFields ? (
          ...
          <>
            ...
            >
              <div className="flex flex-1 items-center gap-2">
                <LayoutList size={16} className="text-neutral-500" />
